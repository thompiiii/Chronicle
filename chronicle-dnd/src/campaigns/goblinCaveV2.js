// ── Goblin Cave V2 ────────────────────────────────────────────────────────
// V2 adds enemy behavior patterns, intent telegraphing, and status effects.
// All combat enemies gain: behavior (turn pattern) and turnIndex.

export const goblinCaveV2Campaign = {
  id:   "goblin-cave-v2",
  name: "The Goblin Cave (V2)",
  desc: "A merchant's missing cart was traced to a cave in the Thornwood. V2: enemies telegraph their moves.",
  ...
  steps: {
    ...
    "patrol-front": {
      ...
      enemy: {
        name: "Goblin Patrol (×2)", hp: 10, attack: 3, xp: 50, difficulty: 11,
        behavior: ["attack", "attack", "heavy"],
        turnIndex: 0,
      },
    ...
    sleeper: {
      ...
      enemy: {
        name: "Groggy Goblin", hp: 5, attack: 2, xp: 25, difficulty: 8,
        behavior: ["attack", "heavy", "attack"],
        turnIndex: 0,
      },
    ...
    "sleeper-loot": {
      ...
      text:  "The goblin slumps. You rifle through its tattered vest and find a small vial — a healing potion, probably nicked from a merchant.",
      loot: {
        gold:  5,
        items: [
          { name: "Health Potion", type: "Consumable", desc: "Restores 2d4+2 HP", effect: { type: "heal", numDice: 2, sides: 4, bonus: 2 } },
    ...
    chieftain: {
      ...
      enemy: {
        name: "Grix the Chieftain", hp: 22, attack: 5, xp: 150, difficulty: 12,
        behavior: ["attack", "heavy", "attack", "attack", "heavy"],
        turnIndex: 0,
      },
